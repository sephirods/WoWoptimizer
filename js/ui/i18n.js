...
const I18N_TRANSLATIONS = {
  en: {
    ...
    toggleVaultAutoScale: "Vault Auto-Scale",
    toggleVaultAutoScaleHelp: "Auto-scale Great Vault items to match the highest owned item level in that slot (up to track max)",
  ...
  es: {
    ...
    simMaxIlvl: "Max ilvl",
    simVenomstones: "Venomstones",
    toggleVaultAutoScale: "Auto-escalar Vault",
    toggleVaultAutoScaleHelp: "Escala automáticamente ítems de la Gran Cámara igualando el ilvl más alto que posees en ese slot (hasta el máximo de su track)",
